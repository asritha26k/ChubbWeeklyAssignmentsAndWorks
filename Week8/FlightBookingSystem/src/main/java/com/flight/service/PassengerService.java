...
public class PassengerService {
	...
	public ResponseEntity<Integer> add(PassengerRequest req) {
		...
		Passenger savedPassenger = passRepo.save(newPassenger);
		return ResponseEntity.status(HttpStatus.CREATED).body(savedPassenger.getPassengerId());
